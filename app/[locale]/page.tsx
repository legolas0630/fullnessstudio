  ...
  return (
    <section className="py-28 relative overflow-hidden bg-[#241309] text-white px-6">
      ...
      <div className="relative z-20 max-w-4xl mx-auto text-center flex flex-col items-center">
        ...
        <Link href="/ceremonia-cacao" className="inline-flex items-center justify-center border border-[#E5C158] text-[#E5C158] px-8 py-4 text-xs uppercase tracking-widest font-medium hover:bg-[#E5C158] hover:text-black active:scale-95 transition-all">
          {t('btn')}
        </Link>
      </div>
    </section>
